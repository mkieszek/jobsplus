...
namespace OpenERPOutlookPlugin
{
    ...
    public class Connect : Object, Extensibility.IDTExtensibility2
    {
        ...
        private office.CommandBarButton btn_open_candidate_form;
        ...
        public void OnStartupComplete(ref System.Array custom)
        {
            ...
            try
            {
                ...
                if (newMenuBar != null)
                {
                    ...
                    btn_open_candidate_form = (office.CommandBarButton)newMenuBar.Controls.Add(office.MsoControlType.msoControlButton, omissing, omissing, 4, true);
                    btn_open_candidate_form.Style = office.MsoButtonStyle.msoButtonIconAndCaption;
                    btn_open_candidate_form.Caption = "candidate";
                    //Face ID will use to show the ICON in the left side of the menu.
                    btn_open_candidate_form.FaceId = 3204;
                    newMenuBar.Visible = true;
                    btn_open_candidate_form.Click += new Microsoft.Office.Core._CommandBarButtonEvents_ClickEventHandler(this.btn_open_candidate_form_Click);
                }
        ...
        void btn_open_candidate_form_Click(Microsoft.Office.Core.CommandBarButton Ctrl, ref bool CancelDefault)
        {
            try
            {
                Connect.isLoggedIn();
                ...
                if (countMail() == 1)
                {
                    frm_candidate frm = new frm_candidate();
                    frm.Show();
                }
                if (countMail() > 1)
                {
                    frm_candidate_multi frm = new frm_candidate_multi();
                    frm.Show();
                }
            }
            catch (Exception e)
